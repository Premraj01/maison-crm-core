...
import { Bell, Building2, ChevronLeft, ChevronRight, Component, LayoutDashboard, LogOut, Menu, Moon, Search, Settings, Sun, UserRound, UsersRound } from "lucide-react";
...
export function AppShell({children}:{children:ReactNode}){
  const {theme,setTheme,role,railCollapsed,setRailCollapsed}=useCrm(); const {user,signOut}=useAuth(); const [mobile,setMobile]=useState(false);
